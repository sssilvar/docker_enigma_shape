function fHandles = multiSurfaceOverlayDetailedCheck( imgOrig, verticesOrig, facesOrig, surfColor,...
...
fHandles=zeros(length(vertices),1, 'uint8');aHandles=cell(length(vertices),1);
