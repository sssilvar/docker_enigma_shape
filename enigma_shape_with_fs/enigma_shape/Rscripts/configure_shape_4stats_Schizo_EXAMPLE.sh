...
cohort=FIDMAG											#Cohort name (must be unique, but the name is up to you)
fsdir=/ifs/loni/faculty/thompson/four_d/Artemis/Shape/ENIGMA_SZ/FIDMAG/FIDMAG_FS		#FreeSurfer output directory
covariates=/ifs/loni/faculty/thompson/four_d/Artemis/Shape/ENIGMA_SZ/FIDMAG/Covariates.csv	#Covariates files
outdir=/ifs/loni/faculty/thompson/four_d/Artemis/Shape/ENIGMA_SZ/FIDMAG/FIDMAG_output		#Shape output directory
exclude_file=/ifs/loni/faculty/thompson/four_d/disaev/la2/ENIGMA_SZ/FIDMAG/misc/QA_Status.csv	#Visual quality check score

####--Section 2. This should be edited only once when first placing the R scripts on your system--#######

demons_dir=/ifshome/bgutman/MedialDemonsShared							#Shape program directory
Rscript_dir=/ifshome/bgutman/MedialDemonsShared/Rscripts					#Rscript directory
R_binary=/usr/local/R-3.1.3/bin/R								#R binary
...
model_list=ENIGMA_SCHIZO_SHAPE1
