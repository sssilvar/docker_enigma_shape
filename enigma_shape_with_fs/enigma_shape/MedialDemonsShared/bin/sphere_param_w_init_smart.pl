...
#$Cmd_str = "$bin_dir/ccbbm -spheremaptest $mesh_file ${working_dir}/sphere_init.m 0.0 $step_size_init -max_iters $iters_init";
#print "$Cmd_str\n";
#system $Cmd_str;

$Cmd_str = "$bin_dir/ccbbm -spheremaptest $mesh_file $sphere_out 0.0 $step_size_init  -max_iters $iters -smart_init -second_round $dir_weight $step_size";
print "$Cmd_str\n";
system $Cmd_str;
